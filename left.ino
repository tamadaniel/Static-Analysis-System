...
char ssid[] = "NETGEAR80"; //"320063FF";//"ASUS"; //your network SSID (name)
char pass[] ="qwer1234"; // "0332154160";//"kawalab211";// your network password

WiFiClient client;
//TCPClient client;
 
unsigned long myChannelNumber = 000000; //update
const char * myWriteAPIKey = "2UDMJ53XU6R682AZ"; //update left
